...
namespace DagYig
{
    public partial class frmWylieToTib : Form
    {
        ...
        public frmWylieToTib()
        {
            InitializeComponent();
            this.TopMost = true;
            txtConvert.Font = Settings.Default.ScanFont;
        ...
        private void btnConvertToTib_Click(object sender, EventArgs e)
        {
            ...
            txtConvert.Font = Settings.Default.DictTibFont;
            sb = null;
        }
        ...
        private void txtConvert_OnTextChanged(object sender, EventArgs e)
        {
            ...
            char c = test[0];
            if (IsTibetan(c)) { txtConvert.Font = Settings.Default.DictTibFont; }
            else { txtConvert.Font = Settings.Default.ScanFont; }
        }
    }
}
